...
{{
  "feature_name": "VolatilityRegimeIndicator_20_60",
  "feature_description": "This feature aims to identify volatility regimes by comparing short-term volatility with long-term volatility.",
  "feature_formulation": "(Short-term Volatility / Long-term Volatility) - 1",
...
{{
  "feature_name": "VolatilityRegimeIndicator_20_60",
  "feature_description": "This feature aims to identify volatility regimes...",
  "feature_formulation": "(Short-term Volatility / Long-term Volatility) - 1",
  "feature_variables": {{  // <-- INCORRECT! This is a nested object, not a string.
